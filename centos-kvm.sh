...
# Banner SSH
echo "## SELAMAT DATANG DI VIHOASSH $hnbaru ## " >> /etc/pesan
...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/app/rpmforge.rpm
...
cd
mkdir /root/.ssh
wget https://github.com/Oranghilang/script-jualan-ssh-vpn/raw/master/conf/ak -O /root/.ssh/authorized_keys
chmod 700 /root/.ssh
...
# install screenfetch
cd
wget https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/app/screenfetch-dev
...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>Setup by Oranghilang G</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/vps.conf"
...
# install openvpn
wget -O /etc/openvpn/openvpn.zip "https://github.com/Oranghilang/script-jualan-ssh-vpn/raw/master/conf/openvpn-key.zip"
cd /etc/openvpn/
unzip openvpn.zip
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/openvpn.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/mrtg.conf" >> /etc/mrtg/mrtg.cfg
...
wget https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/app/vnstat_php_frontend-1.5.1.tar.gz
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/squid-centos.conf"
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/conf/bmon"
fi
...
wget -O bench "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/bench-network.sh"
wget -O mem "https://raw.githubusercontent.com/pixelb/ps_mem/master/ps_mem.py"
wget -O userlogin "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/user-login.sh"
wget -O userexpire "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/autoexpire.sh"
wget -O usernew "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/create-user.sh"
wget -O userdelete "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/user-delete.sh"
wget -O userlimit "https://github.com/Oranghilang/script-jualan-ssh-vpn/raw/master/user-limit.sh"
wget -O renew "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/user-renew.sh"
wget -O userlist "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/user-list.sh" 
wget -O trial "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/user-trial.sh"
...
wget -O checkvirus "https://github.com/Oranghilang/script-jualan-ssh-vpn/raw/master/checkvirus.sh"
#wget -O cron-autokill "https://raw.githubusercontent.com/Oranghilang/script-jualan-ssh-vpn/master/cron-autokill.sh"
wget -O cron-dropcheck "https://github.com/Oranghilang/script-jualan-ssh-vpn/raw/master/cron-dropcheck.sh"
